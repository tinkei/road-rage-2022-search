...
class MotionPlanner:
    ...
    @staticmethod
    def all_lanelets_by_merging_successors_from_lanelet(lanelet: Lanelet, network: LaneletNetwork) -> list:
        """
    ...
    def translate_primitive_to_current_state(self, primitive: MotionPrimitive, path_current: List[State]) -> List[State]:
        """
    ...
    def append_path(self, path_current: List[State], newPath: List[State]) -> List[State]:
        """
    ...
    def search_alg(self, list_successors_start_state: List[MotionPrimitive], max_tree_depth: int, dict_status = None) -> (List[State], List[MotionPrimitive]):
        """
